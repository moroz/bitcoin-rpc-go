...
var HMAC_WALLET_DERIVATION_KEY = argon2.IDKey(config.SECRET_KEY_BASE, []byte("hmac"), config.ARGON2ID_TIME, config.ARGON2ID_MEMORY, config.ARGON2ID_PARALLELISM, 32)
